(defpackage :lem-lisp-mode/package-inferred-system
  ...
  (:import-from :alexandria
                :format-symbol ;;logoraz
                :make-keyword
                :if-let
                :when-let
                :lastcar)
  (:export #:*uninterned-defpackage-p*))
...
(defun ensure-uninterned-symbol (package-name) ;;logoraz
  "Ensure PACKAGE-NAME is an uninterned symbol."
  (etypecase package-name
...
(defun replace-buffer-text-to-defpackage-2 (buffer package-name) ;;logoraz
  "Generate defpackage skeleton utilizes uninterned symbols in lieu of keywords."
